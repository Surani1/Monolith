...
ent-WeaponPhaseBlade = нанолюминитный фазовый клинок
    .desc = Тяжёлый клинок, часто встречавшийся у воинов эпохи до Раскола. Может быть активирован для выбора режима работы с целью подстройки под боевые нужды.
